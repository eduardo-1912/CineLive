...
class Bilhete extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['compra_id', 'sessao_id', 'lugar', 'preco', 'pagamento', 'codigo', 'estado'], 'required'],
            [['compra_id', 'sessao_id', 'lugar', 'preco', 'pagamento'], 'integer'],
            [['estado'], 'string'],
    ...
    {
        return $this->estado === self::ESTADO;
    }

    public function setEstadoTo()
    {
        $this->estado = self::ESTADO;
    }
}
